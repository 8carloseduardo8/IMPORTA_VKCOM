...
public class Comunicador extends Integrador {
	...
	private void enviaPedido(Pedido pedido) throws Exception {
		...
		if (!res.next()) {
			...
			// mensagem +=
			// "Pedido não processado por falta de cadastro do cliente na
			// filial!"
			// + System.lineSeparator();
			// mensagem += "Segue abaixo informações do cliente:"
			// + System.lineSeparator();
			// mensagem += "CNPJ: " + pedido.cnpj + System.lineSeparator();
			// mensagem += "RAZÃO: " + pedido.clienteRazao
			// + System.lineSeparator();
	...
	public static String montaEmailClienteNaoCadastrado(Pedido pedido) throws Exception {
		...
		html += "<p class=MsoNormal>Atenção!</p>";
		...
		html += "<p class=MsoNormalCxSpMiddle><b>RAZÃO</b>              " + pedido.clienteRazao + "</p>";
