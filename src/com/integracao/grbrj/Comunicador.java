...
public class Comunicador extends Integrador {
	...
	public static void main(String[] args) {
		try {
			...
			// new Comunicador().recebeDevolucoes();
	...
	public Comunicador(Finaliza f, ServletIntegradorNormal integrador) {
		super(f, integrador, "GRB-RJ");
		con = Conector.getConexaoGRBRJ();
	}
	...
	public void recebePedidos() throws Exception {
		...
		sql += "    select NUMERO from geral.pedido@dbl_rj ";
		...
		sql += "     select nh_numero from unisys.tnfhven0001@dbl_rj ";
	...
	public void enviaPedidos() throws Exception {
		...
		// .executar(
		// "update ven_pedido set status = 'PENDENTE EXPORTAÇÃO', MOTIVODATA =
		// SYSDATE, MOTIVO = 'LIBERADO AUTOMATICAMENTE - CENTRAL DE PEDIDOS'
		// WHERE STATUS = 'BLOQUEIO COMERCIAL' and equipe = 'MIP' and canal = "
		// + canal);
	...
	public void recebeDevolucoes() throws Exception {
		...
		sql += " FROM UNISYS.TNFHCOM0001@DBL_RJ H, UNISYS.TNFICOM0001@DBL_RJ I, UNISYS.TCADCLI0001@DBL_RJ C  ";
	...
	public void recebeEstoque() throws Exception {
		...
		// String sql = "SELECT * FROM unisys.view_estoquegeral";
