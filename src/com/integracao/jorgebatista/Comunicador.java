package com.integracao.jorgebatista;
...
public class Comunicador extends Integrador {
	...
	public String host = "201.30.158.147";
	// public String host = "";
	public String usuario = "cifarma";
	public String senha = "farma";

	public String pastaPedido = "/entrada";
	public String pastaNFe = "/saida";
	public String pastaRetornoPedido = "/saida";

	private HashMap<String, String> motivos = new HashMap<String, String>();

	public static void main(String argv[]) {
		try {
			// new Comunicador(12).recebePedidos();
			// new Comunicador(13).recebePedidos();
			// new Comunicador(14).recebePedidos();
			// new Comunicador(15).recebePedidos();
			// new Comunicador(16).recebePedidos();
			// new Comunicador(17).recebePedidos();
			// new Comunicador(18).recebePedidos();
			// new Comunicador(19).recebePedidos();

			new Comunicador(12).enviaPedidos();
			new Comunicador(13).enviaPedidos();
			new Comunicador(14).enviaPedidos();
			new Comunicador(15).enviaPedidos();
			new Comunicador(16).enviaPedidos();
			new Comunicador(17).enviaPedidos();
			new Comunicador(18).enviaPedidos();
			new Comunicador(19).enviaPedidos();
			new Comunicador(23).enviaPedidos();
			new Comunicador(28).enviaPedidos();
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public Comunicador(Finaliza f, int canal, ServletIntegradorNormal integrador) {
		super(f, integrador, "JORGE BATISTA");
		this.canal = canal;
		iniciar();
	}

	private Comunicador(int canal) {
		this.canal = canal;
		iniciar();
	}
